...
public partial class UserListPage : ContentPage
{
    ...
    {
        var users = await GlobalData.Instance.db.GetUsersWithRole3And2And0Alphabetic();
        ...
        labelUsers.Text = (string)Application.Current.Resources["LabelUsers"] + ": " + GlobalData.Instance.db.CountUsersRol3And2And0();
    }
    ...
    private async void BanUserClick(object sender, EventArgs e)
    {
        ...
        if (disabled)
        {
            ...
            var updatedUsers = await GlobalData.Instance.db.GetUsersWithRole3And2And0Alphabetic();
